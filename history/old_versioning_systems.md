...
> Note: `0.45.05` was a development build within the `1.0.0` cycle, but it still used the old versioning system and was not retroactively renamed in any way. When the versioning system was changed to the current one, it began at `1.0.0-beta2`, since it was the 2nd public development version released in that cycle.
### Full Versions
| Segment | Meaning                                                | 
|:--------|:-------------------------------------------------------|
| `0`     | Always `0` due to being a non-public-ready version     |
