...
> [!Note]
> If you want to connect to or clone from a GitHub repository in MCreator, you need the [Remote Workspaces Support](https://mcreator.net/plugin/97468/remote-workspaces-support-20232) plugin. If you just download the source, this is not needed.
